...
pub fn render_builder(items items: List(Item), counts counts: Counts, category category: Category) -> StringBuilder {
...
<body class=\"learn-bar\">
  ...
  <div class=\"todomvc-wrapper\">
    ...
    let builder = string_builder.append(builder, "\" href=\"/\">All</a>
          </li>
          <li>
            <a hx-boost=\"true\" class=\"")
    ...
    let builder = string_builder.append(builder, "\" href=\"/active\">Active</a>
          </li>
          <li>
            <a hx-boost=\"true\" class=\"")
    ...
    let builder = string_builder.append(builder, "\" href=\"/completed\">Completed</a>
          </li>
        </ul>
    ...
    let builder = case item.any_completed(counts) {
        True -> {
                let builder = string_builder.append(builder, "
          Clear Completed (")
    let builder = string_builder.append(builder, int.to_string(counts.completed))
    let builder = string_builder.append(builder, ")
          ")
...
pub fn render(items items: List(Item), counts counts: Counts, category category: Category) -> String {
    string_builder.to_string(render_builder(items: items, counts: counts, category: category))
}
